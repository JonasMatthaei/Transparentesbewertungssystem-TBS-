        ...
        <header class="mdl-layout__header">
            <div class="mdl-layout__header-row">
                ...
                <nav class="mdl-navigation mdl-layout--large-screen-only">
                    <a class="mdl-navigation__link" href="class_inspection_overview.php">Klasse</a>
                </nav>
            </div>
        </header>
            ...
            <div class="page-content">
                ...
                <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    ...
                    <div class="mdl-card__actions mdl-card--border">
                        <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="class_inspection_overview.php">
                        Hier zu Ihren Klassen
                      </a>
                    </div>
